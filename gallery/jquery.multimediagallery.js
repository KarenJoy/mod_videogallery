...
var MultimediaGallery = {
	...
	*/
	start					: function () {
		$.get('multimedia.class.php', {op:'getTotalFiles',cmid:document.getElementById("cmid").value}, function(data) {
	...
	*/
	display					: function () {
		...
		$.get('multimedia.class.php', {op:'display',req:nmb_toLoad,cursor:MultimediaGallery.data.loaded,cmid:document.getElementById('cmid').value} , function(data) {
