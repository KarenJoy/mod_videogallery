...
function xmldb_videogallery_upgrade($oldversion) {
     ...
     * for demonstrative purposes and to show how the videogallery
     * iself has been upgraded.
     *
     * For each upgrade block, the file videogallery/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field intro to be added to videogallery.
        $table = new xmldb_table('videogallery');
        ...
        // Define field introformat to be added to videogallery.
        $table = new xmldb_table('videogallery');
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to videogallery.
        $table = new xmldb_table('videogallery');
        ...
        // Define field timemodified to be added to videogallery.
        $table = new xmldb_table('videogallery');
        ...
        // Define index course (not unique) to be added to videogallery.
        $table = new xmldb_table('videogallery');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'videogallery');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'videogallery');
    }
